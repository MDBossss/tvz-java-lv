...
public class UnosStudenataController {
    ...
    public void unesiStudenta(){
        ...
        if(invalidInput){
            ...
            Datoteke.addStudent(imeStudentaTextField.getText(),prezimeStudentaTextField.getText(),jmbagStudentaTextField.getText(),datumRodenjaStudentaTextField.getValue());
            displaySucccess();
        }
    }
}
